...
window.addEventListener("load", (): void => {
  ...
  const bannerApiData: BannerDataType[] = [
    { uid: 1, link: "#", image: "images/b1.png", title: "배너1" },
    { uid: 2, link: "#", image: "images/b2.png", title: "배너2" },
    { uid: 3, link: "#", image: "images/b3.png", title: "배너3" },
    { uid: 4, link: "#", image: "images/b4.png", title: "배너4" },
  ];
  // html 태그의 속성의 값 바꾸기
  // html 선택하기
  ...
  // 타이머 만들기
  let bannerTimer: number = setInterval(bannerCange, 1000);
  // 마우스 커서 배너 제어하기
  ...
  bannerAnchorTag!.addEventListener("mouseleave", (): void => {
    // 배너 타이머 다시 실행
    clearInterval(bannerTimer);
    bannerTimer = setInterval(bannerCange, 1000);
  });
});
